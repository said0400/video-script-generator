...
def generate_thumbnail_html(
    ...
    # Pre-compute all values — no backslash inside f-string (Python < 3.12)
...
def generate_all_content(script_data: dict, output_base: str = "output") -> dict:
    ...
    print("  💡  Trend ideas...")
    try:
        results["trend_ideas"] = generate_trend_ideas(script_data, count=10)
    except Exception as e:
